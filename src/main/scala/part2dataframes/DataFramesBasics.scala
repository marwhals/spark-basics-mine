...
import org.apache.spark.sql.types._ // import spark types
...
object DataFramesBasics extends App {
  ...
  // read a DF with your schema -- i.e pass in your own schema
  ...
  // 2 - Read in another file from the resource/data folder
